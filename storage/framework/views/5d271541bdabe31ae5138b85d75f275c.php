<?php $__env->startSection('title', 'Aktivitas - Stekpro Multimedia & Broadcast'); ?>

<?php $__env->startSection('page-title', 'Aktivitas'); ?>
...
<div class="space-y-4">
    ...
    <?php $__empty_1 = true; $__currentLoopData = $activityLogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $log): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <?php if($currentDate !== $logDate): ?>
            <?php $currentDate = $logDate; ?>
            <div class="text-xs font-medium text-[#86868b] uppercase tracking-wider pt-2 pb-1">
                <?php echo e($log->created_at->isToday() ? 'Hari Ini' : ($log->created_at->isYesterday() ? 'Kemarin' : $log->created_at->format('d F Y'))); ?>
            ...
            <div class="p-4">
                <div class="flex items-start gap-3">
                    ...
                    <div class="activity-icon bg-[#f5f5f7] text-[#6e6e73]">
                        <?php echo $typeIcons[$log->type] ?? $defaultIcon; ?>

                    </div>
                    <div class="flex-1 min-w-0">
                        <div class="flex items-start justify-between gap-2">
                            <p class="text-sm"><?php echo e($log->description); ?></p>
                            <span class="text-xs text-[#86868b] whitespace-nowrap"><?php echo e($log->created_at->format('H:i')); ?></span>
                        </div>
                        <div class="flex items-center gap-2 mt-1">
                            <span class="badge-apple !text-[10px] !px-2 !py-0.5 border border-[#e5e5e7]"><?php echo e($log->type_label); ?></span>
                            <?php if($log->ip_address): ?>
                            <span class="text-[10px] text-[#86868b]"><?php echo e($log->ip_address); ?></span>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\customer\dashboard\activity_logs.blade.php ENDPATH**/ ?>