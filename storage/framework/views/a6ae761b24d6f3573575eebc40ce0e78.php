...
<head>
    <meta charset="utf-8">
    <title>Konfirmasi Transaksi #<?php echo e($transaction->kode_transaksi); ?></title>
    <style>
        body {
...
<body>
    ...
    <div class="content">
        <h2>Halo, <?php echo e($transaction->nama_customer); ?>!</h2>
        ...
        <div class="transaction-details">
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    ...
                    <td><?php echo e($transaction->created_at->format('d F Y H:i')); ?></td>
                </tr>
                <tr>
                    <td><strong>Status</strong></td>
                    <td>
                        <span class="status-badge status-<?php echo e($transaction->status_pembayaran); ?>">
                            <?php echo e($transaction->status_pembayaran_label); ?>
                ...
                <tr>
                    ...
                    <td style="font-size: 18px; color: #059669; font-weight: bold;">
                        Rp <?php echo e(number_format($transaction->grand_total, 0, ',', '.')); ?>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom: 1px solid #dee2e6;">
                        <td style="padding: 10px;">
                            <strong><?php echo e($detail->nama_produk); ?></strong><br>
                            <small><?php echo e($detail->jumlah); ?> unit &times; Rp <?php echo e(number_format($detail->harga_per_hari, 0, ',', '.')); ?>/hari</small>
                        </td>
                        <td style="padding: 10px; text-align: center;">
                            <?php echo e($detail->lama_sewa); ?> hari
                        </td>
        ...
        <p style="text-align: center; margin: 30px 0;">
            <a href="<?php echo e($transaction->midtrans_redirect_url ?? '#'); ?>" class="button">
        ...
        <p>
            ...
            Tanggal Pengambilan: <?php echo e(\Carbon\Carbon::parse($transaction->tanggal_pengambilan)->format('d F Y H:i')); ?><br>
    ...
    <div class="footer">
        <p>&copy; <?php echo e(date('Y')); ?> Stekpro Multimedia & Broadcast. All rights reserved.</p>
        <p>Jl. Contoh No. 123, Sukabumi, Indonesia</p>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\PROJECT KP\resources\views\emails\transaction_confirmation.blade.php ENDPATH**/ ?>