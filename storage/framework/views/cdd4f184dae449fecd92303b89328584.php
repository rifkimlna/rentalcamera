...
<?php $__env->startSection('title', 'Edit Ulasan - Stekpro Multimedia & Broadcast'); ?>
        ...
        <div class="w-full max-w-3xl">
            <div class="card bg-white shadow-md">
                <div class="p-5">
                    ...
                    <form action="<?php echo e(route('customer.reviews.update', $review->id)); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex items-center gap-1 justify-center">
                                <input type="radio" name="rating" class="h-4 w-4 text-[#ff9500]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/> value="1" <?php echo e($review->rating == 1 ? 'checked' : ''); ?> />
                                <input type="radio" name="rating" class="h-4 w-4 text-[#ff9500]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/> value="2" <?php echo e($review->rating == 2 ? 'checked' : ''); ?> />
                                <input type="radio" name="rating" class="h-4 w-4 text-[#ff9500]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/> value="3" <?php echo e($review->rating == 3 ? 'checked' : ''); ?> />
                                <input type="radio" name="rating" class="h-4 w-4 text-[#ff9500]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/> value="4" <?php echo e($review->rating == 4 ? 'checked' : ''); ?> />
                                <input type="radio" name="rating" class="h-4 w-4 text-[#ff9500]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/> value="5" <?php echo e($review->rating == 5 ? 'checked' : ''); ?> />
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" class="input-apple w-full" name="judul" 
                                   value="<?php echo e(old('judul', $review->judul)); ?>"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="flex flex-wrap gap-2">
                                <?php $__currentLoopData = $review->foto_ulasan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $photo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="w-24 h-24">
                                        <img src="<?php echo e(asset('storage/' . $photo)); ?>" alt="Review photo" class="w-full h-full object-cover rounded">
                                    </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\customer\reviews\edit.blade.php ENDPATH**/ ?>