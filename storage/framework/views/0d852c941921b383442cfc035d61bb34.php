...
<?php $__env->startSection('title', 'Ulasan Saya - Stekpro Multimedia & Broadcast'); ?>
    ...
    <div class="card bg-white shadow-md">
        <div class="p-5">
            <div class="flex items-center justify-between mb-4">
                ...
                <a href="<?php echo e(route('customer.reviews.available')); ?>" class="btn-dark-apple btn-sm">
                    ...
                    <table class="w-full">
                        ...
                        <tbody>
                            <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td>
                                        <?php echo e(\Carbon\Carbon::parse($review->created_at)->translatedFormat('d M Y')); ?>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-3">
                                            ...
                                            <?php endif; ?>
                                            <div>
                                                <h6 class="font-semibold mb-1"><?php echo e($review->produk->nama_produk); ?></h6>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-0.5">
                                            <?php for($i = 1; $i <= 5; $i++): ?>
                                                <input type="radio" name="list-rating-<?php echo e($review->id); ?>" class="h-4 w-4 text-[#ff9500]" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z"/> disabled <?php echo e($i <= $review->rating ? 'checked' : ''); ?> />
                                            <?php endfor; ?>
                                            <br>
                                    ...
                                    <td>
                                        <div class="flex flex-col sm:flex-row gap-1">
                                            <a href="<?php echo e(route('customer.reviews.show', $review->id)); ?>" 
                                            ...
                                            <?php if($review->status == 'pending'): ?>
                                                ...
                                                <button type="button" 
                                                        ...
                                                        data-delete-url="<?php echo e(route('customer.reviews.destroy', ':id')); ?>"
                                                        title="Hapus">
                                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
            ...
            <?php else: ?>
                <div class="text-center py-8">
                    ...
                    <a href="<?php echo e(route('customer.reviews.available')); ?>" class="btn-dark-apple">
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\customer\reviews\index.blade.php ENDPATH**/ ?>