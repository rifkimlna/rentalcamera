<?php $__env->startSection('title', 'Manajemen Ulasan - Stekpro Multimedia & Broadcast'); ?>
...
<div>
    ...
    <div class="bg-white rounded-2xl border border-[#f0f0f2] mb-4">
        <div class="p-5">
            <form method="GET" action="<?php echo e(route('admin.reviews.index')); ?>" class="grid grid-cols-1 md:grid-cols-5 gap-4">
                <div>
                    <label for="search" class="block text-xs font-medium text-[#86868b] mb-1.5"><span class="">Cari</span></label>
                    <input type="text" class="input-apple w-full" id="search" name="search" value="<?php echo e(request('search')); ?>" placeholder="Produk, user, atau komentar...">
                </div>
                <div>
                ...
                <div>
                    ...
                    <select class="select-apple w-full" id="rating" name="rating">
                        ...
                        <?php $__currentLoopData = $ratings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($r); ?>" <?php echo e(request('rating') == $r ? 'selected' : ''); ?>><?php echo e($r); ?> Bintang</option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div>
                    <label for="date_from" class="block text-xs font-medium text-[#86868b] mb-1.5"><span class="">Dari Tanggal</span></label>
                    <input type="date" class="input-apple w-full" id="date_from" name="date_from" value="<?php echo e(request('date_from')); ?>">
                </div>
                <div>
                    <label for="date_to" class="block text-xs font-medium text-[#86868b] mb-1.5"><span class="">Sampai Tanggal</span></label>
                    <input type="date" class="input-apple w-full" id="date_to" name="date_to" value="<?php echo e(request('date_to')); ?>">
                </div>
                <div class="flex items-end gap-2">
                    <button type="submit" class="btn-dark-apple">Filter</button>
                    <a href="<?php echo e(route('admin.reviews.index')); ?>" class="text-[#6e6e73] hover:bg-[#f5f5f7] rounded-xl px-3 py-2 text-sm transition-colors">Reset</a>
                </div>
            </form>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-[#f0f0f2]">
        <div class="p-5">
            <div class="flex items-center justify-between mb-4">
                <div>
                    <span class="text-[#6e6e73]">Total: <?php echo e($reviews->total()); ?> ulasan</span>
                </div>
            </div>
                        ...
                        <tbody>
                            <?php $__currentLoopData = $reviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $review): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <td>
                                        <div class="flex items-center gap-2">
                                            ...
                                            <span class="font-medium">
                                                <?php echo e($review->produk->nama_produk ?? 'Produk dihapus'); ?>

                                            </span>
                                        </div>
                                    </td>
                                    <td><?php echo e($review->user->nama ?? 'Anonim'); ?></td>
                                    <td>
                                        <div class="flex items-center gap-0.5">
                                            ...
                                            <?php endfor; ?>
                                            <br>
                                            <small class="text-[#6e6e73]"><?php echo e($review->rating); ?>/5</small>
                                        </div>
                                    </td>
                                    <td>
                                        ...
                                        <?php if($review->hasPhotos()): ?>
                                            <br>
                                            <small class="text-[#6e6e73]"><?php echo e($review->getPhotoCount()); ?> foto</small>
                                        <?php endif; ?>
                                        <?php if($review->hasReply()): ?>
                                            <br>
                                    ...
                                    <td>
                                        <small><?php echo e(\Carbon\Carbon::parse($review->created_at)->translatedFormat('d M Y')); ?></small>
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\reviews\index.blade.php ENDPATH**/ ?>