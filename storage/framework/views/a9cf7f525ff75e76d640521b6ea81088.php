...
unset($__errorArgs, $__bag); ?>"
                                               id="nama_produk" name="nama_produk" value="<?php echo e(old('nama_produk', $product->nama_produk)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                               id="kode_produk" name="kode_produk" value="<?php echo e(old('kode_produk', $product->kode_produk)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($category->id); ?>" <?php echo e(old('kategori_id', $product->kategori_id) == $category->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                              id="deskripsi_singkat" name="deskripsi_singkat" rows="2"><?php echo e(old('deskripsi_singkat', $product->deskripsi_singkat)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>"
                                              id="deskripsi_lengkap" name="deskripsi_lengkap" rows="4"><?php echo e(old('deskripsi_lengkap', $product->deskripsi_lengkap)); ?></textarea>
                        ...
                        <div class="bg-white rounded-2xl border border-[#f0f0f2] mb-4">
                            <div class="p-5">
                                ...
                                <div id="specifications-container">
                                    <?php
                                        $specifications = is_array($product->spesifikasi) ? $product->spesifikasi : (json_decode($product->spesifikasi, true) ?? []);
                                        $specIndex = 0;
                                    ?>
                                    ...
                                    <?php else: ?>
                                        <?php $__currentLoopData = $specifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="specification-row grid grid-cols-1 md:grid-cols-5 gap-2 mb-2 items-end">
                                                <div class="md:col-span-2">
                                                    <input type="text" class="input-apple w-full" name="spesifikasi[<?php echo e($specIndex); ?>][key]"
                                                           value="<?php echo e($key); ?>" placeholder="Nama Spesifikasi">
                                                </div>
                                                <div class="md:col-span-2">
                                                    <input type="text" class="input-apple w-full" name="spesifikasi[<?php echo e($specIndex); ?>][value]"
                                                           value="<?php echo e($value); ?>" placeholder="Nilai">
                                                </div>
                                                <div>
...
unset($__errorArgs, $__bag); ?>"
                                              id="fitur" name="fitur" rows="3" placeholder="Contoh: WiFi, GPS, Weather Sealing, Touchscreen"><?php echo e(old('fitur', $product->fitur)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <div class="bg-white rounded-2xl border border-[#f0f0f2] mb-4">
                            <div class="p-5">
                                <h2 class="text-lg font-semibold text-[#1d1d1f]">Gambar Saat Ini</h2>
                                <?php if($product->gambar_utama): ?>
                                    <div>
                                        <label class="block text-xs font-medium text-[#86868b] mb-1.5"><span class="">Gambar Utama</span></label>
                                        <div class="relative">
                                            <img src="<?php echo e(asset('storage/' . $product->gambar_utama)); ?>" alt="<?php echo e($product->nama_produk); ?>"
                                                 class="rounded mb-2 w-full" style="max-height: 150px; object-fit: cover;">
                                            <button type="button" class="btn-dark-apple !text-sm !px-3 !py-1.5 w-9 h-9 flex items-center justify-center text-[#d70015] hover:bg-[#fef2f2] rounded-xl transition-colors absolute top-1 right-1 delete-image-btn"
                                                data-type="utama"
                                                data-image-path="<?php echo e($product->gambar_utama); ?>">
                                ...
                                <?php if(!empty($additionalImages)): ?>
                                    <div class="mt-4">
                                        <label class="block text-xs font-medium text-[#86868b] mb-1.5"><span class="">Gambar Tambahan</span></label>
                                        <div class="grid grid-cols-2 gap-2">
                                            <?php $__currentLoopData = $additionalImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="relative">
                                                    <img src="<?php echo e(asset('storage/' . $image)); ?>" alt="Gambar tambahan <?php echo e($product->nama_produk); ?>"
                                                         class="rounded w-full" style="height: 80px; object-fit: cover;">
                                                    <button type="button" class="btn-dark-apple !text-sm !px-3 !py-1.5 w-9 h-9 flex items-center justify-center text-[#d70015] hover:bg-[#fef2f2] rounded-xl transition-colors absolute top-1 right-1 delete-image-btn"
                                                        data-type="tambahan"
                                                        data-image-path="<?php echo e($image); ?>"
                        ...
                        <div class="bg-white rounded-2xl border border-[#f0f0f2] mb-4">
                            <div class="p-5">
                                <h2 class="text-lg font-semibold text-[#1d1d1f]">Update Gambar</h2>
                                <div>
                                    <label for="gambar_utama" class="block text-xs font-medium text-[#86868b] mb-1.5"><span class="">Ganti Gambar Utama</span></label>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-4">
                                    <label for="gambar_tambahan" class="block text-xs font-medium text-[#86868b] mb-1.5"><span class="">Tambah Gambar</span></label>
...
unset($__errorArgs, $__bag); ?>"
                                               id="harga_per_hari" name="harga_per_hari" value="<?php echo e(old('harga_per_hari', $product->harga_per_hari)); ?>" required>
                                    </div>
...
unset($__errorArgs, $__bag); ?>"
                                               id="minimum_sewa" name="minimum_sewa" value="<?php echo e(old('minimum_sewa', $product->minimum_sewa)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                               id="maximum_sewa" name="maximum_sewa" value="<?php echo e(old('maximum_sewa', $product->maximum_sewa)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="stok_total" name="stok_total" value="<?php echo e(old('stok_total', $product->stok_total)); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="unavailable" <?php echo e(old('status', $product->status) == 'unavailable' ? 'selected' : ''); ?>>Tidak Tersedia</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>"
                                        ...
                                        <option value="baru" <?php echo e(old('kondisi', $product->kondisi) == 'baru' ? 'selected' : ''); ?>>Baru</option>
                                        <option value="bekas_excellent" <?php echo e(old('kondisi', $product->kondisi) == 'bekas_excellent' ? 'selected' : ''); ?>>Bekas (Excellent)</option>
                                        <option value="bekas_good" <?php echo e(old('kondisi', $product->kondisi) == 'bekas_good' ? 'selected' : ''); ?>>Bekas (Good)</option>
                                        <option value="bekas_fair" <?php echo e(old('kondisi', $product->kondisi) == 'bekas_fair' ? 'selected' : ''); ?>>Bekas (Fair)</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-4">
                                    <label class="block text-xs font-medium text-[#86868b] mb-1.5 cursor-pointer">
                                        ...
                                        <input type="checkbox" class="w-11 h-6 bg-[#e5e5e7] rounded-full relative cursor-pointer transition-colors checked:bg-[#0071e3] after:content-[""] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all" id="is_featured" name="is_featured" value="1"
                                ...
                                <div class="mt-2">
                                    <label class="block text-xs font-medium text-[#86868b] mb-1.5 cursor-pointer">
                                        ...
                                        <input type="checkbox" class="w-11 h-6 bg-[#e5e5e7] rounded-full relative cursor-pointer transition-colors checked:bg-[#0071e3] after:content-[""] after:absolute after:top-0.5 after:left-0.5 after:bg-white after:rounded-full after:h-5 after:w-5 after:transition-all" id="is_recommended" name="is_recommended" value="1"
                                               <?php echo e(old('is_recommended', $product->is_recommended) ? 'checked' : ''); ?>>
                                    </label>
                                </div>
                            </div>
                        </div>
...
unset($__errorArgs, $__bag); ?>"
                                           id="berat" name="berat" value="<?php echo e(old('berat', $product->berat)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                           id="dimensi" name="dimensi" value="<?php echo e(old('dimensi', $product->dimensi)); ?>" placeholder="Contoh: 15 x 10 x 5">
...
unset($__errorArgs, $__bag); ?>"
                                           id="serial_number" name="serial_number" value="<?php echo e(old('serial_number', $product->serial_number)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                                           id="tahun_pembuatan" name="tahun_pembuatan" value="<?php echo e(old('tahun_pembuatan', $product->tahun_pembuatan)); ?>" maxlength="4">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\products\edit.blade.php ENDPATH**/ ?>