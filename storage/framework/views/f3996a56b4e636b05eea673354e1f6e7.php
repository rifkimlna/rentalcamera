...
<?php $__env->startSection('page-title', 'Edit Studio'); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-white rounded-2xl border border-[#f0f0f2] max-w-2xl">
    <div class="p-5">
        <form method="POST" action="<?php echo e(route('admin.studio.update', $studio->id)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?> <?php echo method_field('PUT'); ?>

            <div class="mb-3">
                <label class="block text-xs font-medium text-[#86868b] mb-1.5"><span class="">Nama Studio *</span></label>
                <input type="text" name="nama_studio" class="input-apple w-full" value="<?php echo e(old('nama_studio', $studio->nama_studio)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" class="input-apple resize-none w-full" rows="4"><?php echo e(old('deskripsi', $studio->deskripsi)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <textarea name="fasilitas" class="input-apple resize-none w-full" rows="3" placeholder="AC, Sound System, Green Screen, ..."><?php echo e(old('fasilitas', $studio->fasilitas)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="harga_per_jam" class="input-apple w-full" value="<?php echo e(old('harga_per_jam', $studio->harga_per_jam)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <?php if($studio->gambar_utama): ?>
                    <div class="mb-2">
                        <img src="<?php echo e(asset('storage/' . $studio->gambar_utama)); ?>" alt="<?php echo e($studio->nama_studio); ?>" class="w-24 h-24 object-cover rounded">
                    </div>
                <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <select name="status" class="select-apple w-full">
                    <option value="active" <?php echo e(old('status', $studio->status) == 'active' ? 'selected' : ''); ?>>Active</option>
                    <option value="inactive" <?php echo e(old('status', $studio->status) == 'inactive' ? 'selected' : ''); ?>>Inactive</option>
                </select>
            </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\studio\edit.blade.php ENDPATH**/ ?>