<?php $__env->startSection('title', 'Edit Portfolio'); ?>
<?php $__env->startSection('page-title', 'Edit Portfolio'); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-2xl mx-auto">
    <div class="bg-white rounded-2xl border border-[#f0f0f2]">
        <div class="p-6">
            <form method="POST" action="<?php echo e(route('admin.portfolios.update', $portfolio->id)); ?>" enctype="multipart/form-data">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('judul', $portfolio->judul)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" rows="3"><?php echo e(old('deskripsi', $portfolio->deskripsi)); ?></textarea>
                ...
                <div class="mb-4">
                    ...
                    <div class="flex gap-4">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="tipe" value="foto" class="w-4 h-4 text-[#0071e3] bg-white border-[#e5e5e7]" <?php echo e($portfolio->tipe === 'foto' ? 'checked' : ''); ?> onchange="toggleTipe()">
                            <span class="text-sm">Foto</span>
                        </label>
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="radio" name="tipe" value="video" class="w-4 h-4 text-[#0071e3] bg-white border-[#e5e5e7]" <?php echo e($portfolio->tipe === 'video' ? 'checked' : ''); ?> onchange="toggleTipe()">
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('url', $portfolio->url)); ?>" placeholder="https://www.instagram.com/p/...">
                    <?php $__errorArgs = ['url'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="mb-4" id="gambar_input">
                    ...
                    <?php if($portfolio->gambar_url): ?>
                    <div class="mb-2">
                        <img src="<?php echo e($portfolio->gambar_url); ?>" class="w-32 h-24 object-cover rounded" alt="<?php echo e($portfolio->judul); ?>">
                    </div>
                    <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('sort_order', $portfolio->sort_order)); ?>" min="0">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\portfolios\edit.blade.php ENDPATH**/ ?>