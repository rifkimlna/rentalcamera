...
<?php $__env->startSection('title', 'Transaksi yang Dapat Diulas - Stekpro Multimedia & Broadcast'); ?>
        ...
        <div class="p-5">
                        ...
                        <div class="card bg-white border border-[#e5e5e7] hover:shadow-lg transition-shadow">
                            <div class="p-5">
                                <div class="flex items-start justify-between mb-3">
                                    <div>
                                        <h6 class="font-semibold mb-1"><?php echo e($transaction->kode_transaksi); ?></h6>
                                    ...
                                    <div class="space-y-2">
                                        <?php $__currentLoopData = $transaction->detailTransaksis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $detail): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="flex items-center gap-2">
                                                ...
                                                <?php endif; ?>
                                                <div>
                                                    <p class="mb-0 text-sm"><?php echo e($detail->produk ? $detail->produk->nama_produk : $detail->nama_produk); ?></p>
                                                    <small class="text-[#6e6e73]">
                                                        <?php echo e($detail->lama_sewa); ?> hari × Rp <?php echo e(number_format($detail->harga_per_hari, 0, ',', '.')); ?>
                                ...
                                <?php if($unreviewedProducts->count() > 0): ?>
                                    <div class="rounded-xl bg-[#0071e3]/10 border border-[#0071e3]/20 p-3 flex items-center gap-2 text-sm text-[#0071e3] mb-3 p-3">
                                        <small>
                                            ...
                                            Anda dapat memberikan ulasan untuk <?php echo e($unreviewedProducts->count()); ?> produk
                                        </small>
                                    </div>
                                <?php endif; ?>
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <h6 class="mb-0 text-[#6e6e73]">Rp <?php echo e(number_format($transaction->grand_total, 0, ',', '.')); ?></h6>
                                    </div>
                                    <a href="<?php echo e(route('customer.reviews.create', $transaction->id)); ?>" 
            ...
            <?php else: ?>
                <div class="text-center py-8">
                    ...
                    <a href="<?php echo e(route('customer.transactions.index')); ?>" class="btn-dark-apple">
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views/customer/reviews/available.blade.php ENDPATH**/ ?>