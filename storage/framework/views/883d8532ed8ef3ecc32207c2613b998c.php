...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="text-center text-sm">
                    ...
                    <a href="<?php echo e(route('register')); ?>" class="text-[#1d1d1f] font-medium hover:underline">Daftar</a>
                </div>
            </form>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views/auth/login.blade.php ENDPATH**/ ?>