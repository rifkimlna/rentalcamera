...
<body class="font-sans bg-[#f5f5f7] min-h-screen flex items-center justify-center">
    <div class="text-center px-4">
        ...
        <?php if(auth()->guard()->check()): ?>
            <a href="<?php echo e(route('dashboard')); ?>" class="btn-dark-apple inline-flex">Kembali ke Dashboard</a>
        <?php else: ?>
            <a href="<?php echo e(route('login')); ?>" class="btn-dark-apple inline-flex">Masuk</a>
        <?php endif; ?>
    </div>
</body>
</html>
<?php /**PATH C:\laragon\www\PROJECT KP\resources\views\errors\403.blade.php ENDPATH**/ ?>