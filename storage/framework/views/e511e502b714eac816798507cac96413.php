...
<?php $__env->startSection('title', 'Stekpro — Sewa Equipment, Studio & Layanan Kreatif Profesional'); ?>
<?php $__env->startSection('meta-description', 'Sewa kamera, lensa, lighting, studio foto, dan jasa videografer profesional. Gear terawat, harga transparan, booking cepat.'); ?>
    ...
    <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 pb-12 sm:pt-24 lg:pt-32 lg:pb-16">
        <div class="flex gap-8 items-center justify-center flex-col text-center">
            ...
            <div class="mt-14 grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
                <div><p class="text-2xl sm:text-3xl font-semibold tracking-tight text-black"><?php echo e(number_format($statProducts)); ?>+</p><p class="text-[13px] text-neutral-500 mt-1">Unit Equipment</p></div>
                <div><p class="text-2xl sm:text-3xl font-semibold tracking-tight text-black"><?php echo e(number_format($statCustomers)); ?>+</p><p class="text-[13px] text-neutral-500 mt-1">Kreator Percaya Kami</p></div>
                <div><p class="text-2xl sm:text-3xl font-semibold tracking-tight text-black"><?php echo e(number_format($statTransactions)); ?>+</p><p class="text-[13px] text-neutral-500 mt-1">Booking Selesai</p></div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div x-show="activeTab === 'equipment'" x-transition.opacity.duration.250ms class="tab-panel-enter">
            <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-5">
                <?php $__empty_1 = true; $__currentLoopData = ($featuredProducts ?? collect())->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="catalog-card group">
                        <div class="overflow-hidden bg-neutral-100">
                            <?php if(!empty($p->gambar_utama)): ?>
                                <img src="<?php echo e(asset('storage/' . $p->gambar_utama)); ?>" alt="<?php echo e($p->nama_produk); ?>" class="w-full h-auto object-contain block" loading="lazy">
                            <?php else: ?>
                        ...
                        <div class="p-3 sm:p-4">
                            <p class="text-[11px] font-medium uppercase tracking-wider text-neutral-400 mb-1"><?php echo e($p->kategori->nama_kategori ?? 'Equipment'); ?></p>
                            <h3 class="font-semibold text-black text-[13px] sm:text-[15px] leading-snug line-clamp-1"><?php echo e($p->nama_produk); ?></h3>
                            <p class="text-[11px] sm:text-xs text-neutral-400 mt-1"><?php echo e(number_format((float)($p->rating ?? 0), 1)); ?> · <?php echo e($p->jumlah_ulasan ?? 0); ?> ulasan · Stok <?php echo e($p->stok_tersedia ?? '-'); ?></p>
                            <div class="flex items-center justify-between mt-3 pt-3 border-t border-neutral-100">
                                <p class="text-sm sm:text-[15px] font-semibold text-black">Rp <?php echo e(number_format($p->harga_per_hari, 0, ',', '.')); ?><span class="text-xs font-normal text-neutral-400">/hari</span></p>
                                <?php $pUrl = !empty($p->slug) ? route('customer.products.show', $p->slug) : $eqIndex; ?>
                                <a href="<?php echo e($pUrl); ?>" class="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-black hover:bg-neutral-800 text-white text-xs sm:text-[13px] font-medium transition-colors shrink-0">Booking</a>
                            </div>
                        </div>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <?php $__currentLoopData = $dummyEquipment; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="catalog-card group">
                            <div class="aspect-[4/3] overflow-hidden bg-neutral-100 flex items-center justify-center">
                                <svg class="w-10 h-10 sm:w-12 sm:h-12 text-neutral-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.2"><path stroke-linecap="round" stroke-linejoin="round" d="M3 9a2 2 0 012-2h.93a2 2 0 001.664-.89l.812-1.22A2 2 0 0110.07 4h3.86a2 2 0 011.664.89l.812 1.22A2 2 0 0018.07 7H19a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V9z"/><path stroke-linecap="round" stroke-linejoin="round" d="M15 13a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                            </div>
                            <div class="p-3 sm:p-4">
                                <p class="text-[11px] font-medium uppercase tracking-wider text-neutral-400 mb-1"><?php echo e($d['kat']); ?></p>
                                <h3 class="font-semibold text-black text-[13px] sm:text-[15px] leading-snug line-clamp-1"><?php echo e($d['nama']); ?></h3>
                                <p class="text-[11px] sm:text-xs text-neutral-400 mt-1"><?php echo e($d['rating']); ?> · <?php echo e($d['ulasan']); ?> ulasan · Tersedia</p>
                                <div class="flex items-center justify-between mt-3 pt-3 border-t border-neutral-100">
                                    <p class="text-sm sm:text-[15px] font-semibold text-black">Rp <?php echo e(number_format($d['harga'], 0, ',', '.')); ?><span class="text-xs font-normal text-neutral-400">/<?php echo e($d['satuan']); ?></span></p>
                                    <a href="<?php echo e($eqIndex); ?>" class="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-black hover:bg-neutral-800 text-white text-xs sm:text-[13px] font-medium transition-colors shrink-0">Booking</a>
                                </div>
                            </div>
                        </article>
            ...
            <div class="text-center mt-8">
                <a href="<?php echo e($eqIndex); ?>" class="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-white border border-slate-200 text-sm font-bold text-slate-700 hover:border-[#111111]/50 hover:text-[#111111] hover:shadow-lg hover:-translate-y-px transition-all">Lihat Semua Equipment
        ...
        <div x-show="activeTab === 'studio'" x-cloak x-transition.opacity.duration.250ms class="tab-panel-enter">
            <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-5">
                <?php $__empty_1 = true; $__currentLoopData = ($studios ?? collect().take(0)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="catalog-card group">
                        <div class="overflow-hidden bg-neutral-100">
                            <?php if(!empty($s->gambar_utama)): ?>
                                <img src="<?php echo e(asset('storage/' . $s->gambar_utama)); ?>" alt="<?php echo e($s->nama_studio); ?>" class="w-full h-auto object-contain block" loading="lazy">
                            <?php else: ?>
                                <div class="w-full h-full flex items-center justify-center">
                        ...
                        <div class="p-3 sm:p-4">
                            ...
                            <h3 class="font-semibold text-black text-[13px] sm:text-[15px] leading-snug line-clamp-1"><?php echo e($s->nama_studio); ?></h3>
                            <?php $fasList = array_slice(array_filter((array)($s->fasilitas ?? []), 'is_string'), 0, 2); ?>
                            <p class="text-[11px] sm:text-xs text-neutral-400 mt-1 line-clamp-1"><?php echo e(number_format((float)($s->rating ?? 0), 1)); ?> · <?php echo e($s->jumlah_ulasan ?? 0); ?> ulasan<?php echo e(count($fasList) ? ' · ' . implode(' · ', array_map(fn($f) => Str::limit($f, 20), $fasList)) : ''); ?></p>
                            <div class="flex items-center justify-between mt-3 pt-3 border-t border-neutral-100">
                                <p class="text-sm sm:text-[15px] font-semibold text-black">Rp <?php echo e(number_format($s->harga_per_jam, 0, ',', '.')); ?><span class="text-xs font-normal text-neutral-400">/jam</span></p>
                                
                                <?php $sUrl = !empty($s->slug) ? route('customer.studio.show', $s->slug) : $stIndex; ?>
                                <a href="<?php echo e($sUrl); ?>" class="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-black hover:bg-neutral-800 text-white text-xs sm:text-[13px] font-medium transition-colors shrink-0">Booking</a>
                            </div>
                        </div>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <?php $__currentLoopData = $dummyStudio; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="catalog-card group">
                            <div class="aspect-[4/3] overflow-hidden bg-neutral-100 flex items-center justify-center">
                                <svg class="w-10 h-10 sm:w-12 sm:h-12 text-neutral-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.2"><path stroke-linecap="round" stroke-linejoin="round" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5h1v5m-1 0h2"/></svg>
                            </div>
                            <div class="p-3 sm:p-4">
                                <p class="text-[11px] font-medium uppercase tracking-wider text-neutral-400 mb-1">Studio</p>
                                <h3 class="font-semibold text-black text-[13px] sm:text-[15px] leading-snug line-clamp-1"><?php echo e($d['nama']); ?></h3>
                                <p class="text-[11px] sm:text-xs text-neutral-400 mt-1 line-clamp-1"><?php echo e($d['rating']); ?> · <?php echo e($d['ulasan']); ?> ulasan · <?php echo e(implode(' · ', array_slice($d['fasilitas'], 0, 2))); ?></p>
                                <div class="flex items-center justify-between mt-3 pt-3 border-t border-neutral-100">
                                    <p class="text-sm sm:text-[15px] font-semibold text-black">Rp <?php echo e(number_format($d['harga'], 0, ',', '.')); ?><span class="text-xs font-normal text-neutral-400">/<?php echo e($d['satuan']); ?></span></p>
                                    <a href="<?php echo e($stIndex); ?>" class="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-black hover:bg-neutral-800 text-white text-xs sm:text-[13px] font-medium transition-colors shrink-0">Booking</a>
                                </div>
                            </div>
                        </article>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="text-center mt-8">
                <a href="<?php echo e($stIndex); ?>" class="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-white border border-slate-200 text-sm font-bold text-slate-700 hover:border-[#111111]/50 hover:text-[#111111] hover:shadow-lg hover:-translate-y-px transition-all">Lihat Semua Studio
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5-5 5M6 12h12"/></svg>
                </a>
            </div>
        </div>
        ...
        <div x-show="activeTab === 'layanan'" x-cloak x-transition.opacity.duration.250ms class="tab-panel-enter">
            <div class="grid grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-2 sm:gap-5">
                <?php $__empty_1 = true; $__currentLoopData = ($layanans ?? collect()->take(0)); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <article class="catalog-card group flex flex-col overflow-hidden">
                        <?php if(!empty($l->gambar_utama)): ?>
                            <div class="overflow-hidden bg-neutral-100">
                                <img src="<?php echo e(asset('storage/' . $l->gambar_utama)); ?>" alt="<?php echo e($l->nama_layanan); ?>" class="w-full h-auto object-contain block" loading="lazy">
                            </div>
                        <?php endif; ?>
                        <div class="p-3 sm:p-4 flex flex-col flex-1">
                        <p class="text-[11px] font-medium uppercase tracking-wider text-neutral-400 mb-1"><?php echo e($l->kategori ?? 'Layanan'); ?></p>
                        <h3 class="font-semibold text-black text-[13px] sm:text-[15px] leading-snug line-clamp-1"><?php echo e($l->nama_layanan); ?></h3>
                        <p class="text-[11px] sm:text-xs text-neutral-400 mt-1"><?php echo e(number_format((float)($l->rating ?? 0), 1)); ?> · <?php echo e($l->jumlah_ulasan ?? 0); ?> ulasan</p>
                        <p class="hidden sm:block text-[13px] text-neutral-500 line-clamp-2 mt-2"><?php echo e(Str::limit($l->deskripsi ?? 'Tim profesional siap membantu produksi Anda dari awal sampai akhir.', 80)); ?></p>
                        <div class="mt-auto flex items-center justify-between gap-2 pt-3 mt-3 border-t border-neutral-100">
                            <p class="text-sm sm:text-[15px] font-semibold text-black">Rp <?php echo e(number_format($l->harga_mulai, 0, ',', '.')); ?></p>
                            
                            <?php $lUrl = !empty($l->slug) ? route('customer.layanan.show', $l->slug) : $lyIndex; ?>
                            <a href="<?php echo e($lUrl); ?>" class="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-black hover:bg-neutral-800 text-white text-xs sm:text-[13px] font-medium transition-colors shrink-0">Booking</a>
                        </div>
                        </div>
                    </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                    <?php $__currentLoopData = $dummyLayanan; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $d): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <article class="catalog-card group p-3 sm:p-4 flex flex-col">
                            <p class="text-[11px] font-medium uppercase tracking-wider text-neutral-400 mb-1"><?php echo e($d['kat']); ?></p>
                            <h3 class="font-semibold text-black text-[13px] sm:text-[15px] leading-snug line-clamp-1"><?php echo e($d['nama']); ?></h3>
                            <p class="text-[11px] sm:text-xs text-neutral-400 mt-1"><?php echo e($d['rating']); ?> · <?php echo e($d['ulasan']); ?> ulasan</p>
                            <p class="text-[13px] text-neutral-500 mt-2">Tim profesional + peralatan standar broadcast.</p>
                            <div class="mt-auto flex items-center justify-between gap-2 pt-3 mt-3 border-t border-neutral-100">
                                <p class="text-sm sm:text-[15px] font-semibold text-black">Rp <?php echo e(number_format($d['harga'], 0, ',', '.')); ?><span class="text-xs font-normal text-neutral-400">/<?php echo e($d['satuan']); ?></span></p>
                                <a href="<?php echo e($lyIndex); ?>" class="inline-flex items-center px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-black hover:bg-neutral-800 text-white text-xs sm:text-[13px] font-medium transition-colors shrink-0">Booking</a>
                            </div>
                        </article>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php endif; ?>
            ...
            <div class="text-center mt-8">
                <a href="<?php echo e($lyIndex); ?>" class="inline-flex items-center gap-2 px-7 py-3 rounded-full bg-white border border-slate-200 text-sm font-bold text-slate-700 hover:border-[#111111]/50 hover:text-[#111111] hover:shadow-lg hover:-translate-y-px transition-all">Lihat Semua Layanan
                    <svg class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2"><path stroke-linecap="round" stroke-linejoin="round" d="M13 7l5 5-5 5M6 12h12"/></svg>
                </a>
            </div>
        </div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="hidden lg:flex items-start justify-center">
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="reveal <?php echo e($i > 0 ? 'reveal-delay-' . $i : ''); ?> <?php echo e($i % 2 === 1 ? 'mt-44' : ''); ?> shrink-0 w-44 text-center">
                    <div class="text-6xl font-extrabold tracking-tight text-slate-900 leading-none"><?php echo e($s['n']); ?></div>
                    <p class="mt-3 text-lg font-bold text-slate-900 leading-snug"><?php echo e($s['t']); ?></p>
                </div>
                <?php if($i < 3): ?>
                    <?php if($i % 2 === 0): ?>
        ...
        <div class="lg:hidden flex flex-col items-center">
            <?php $__currentLoopData = $steps; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $s): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <?php endif; ?>
                <div class="reveal <?php echo e($i > 0 ? 'reveal-delay-' . $i : ''); ?> text-center">
                    <div class="text-6xl font-extrabold tracking-tight text-slate-900 leading-none"><?php echo e($s['n']); ?></div>
                    <p class="mt-2 text-base font-bold text-slate-900 leading-snug"><?php echo e($s['t']); ?></p>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
...
<section class="bg-white py-16 sm:py-24 overflow-hidden">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div id="testiTrack" class="flex gap-10 sm:gap-14 overflow-x-auto no-scrollbar snap-x snap-mandatory pb-2 -mx-4 px-4 sm:mx-0 sm:px-0 [mask-image:linear-gradient(to_right,transparent,black_3%,black_97%,transparent)]">
            <?php $listTesti = (isset($testimonials) && $testimonials->isNotEmpty()) ? $testimonials : collect($dummyTesti); ?>
            <?php $__currentLoopData = $listTesti; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <figure class="snap-start shrink-0 w-[85%] sm:w-[calc(50%-28px)] lg:w-[calc(33.333%-37px)] relative pt-10">
                    ...
                    <div class="flex text-black gap-1 mb-4">
                        <?php for($i = 1; $i <= 5; $i++): ?>
                            <svg class="w-3.5 h-3.5 <?php echo e($i <= $rate ? '' : 'text-slate-200'); ?>" fill="currentColor" viewBox="0 0 20 20"><path d="M10 1.5l2.6 5.3 5.9.9-4.2 4.1 1 5.8L10 14.9l-5.3 2.7 1-5.8L1.5 7.7l5.9-.9L10 1.5z"/></svg>
                        <?php endfor; ?>
                    </div>
                    <blockquote class="text-base sm:text-lg text-slate-800 leading-relaxed mb-6">“<?php echo e(Str::limit($teks, 180)); ?>”</blockquote>
                    <figcaption class="flex items-center gap-2.5">
                        <span class="w-6 h-[2px] bg-[#111111] shrink-0"></span>
                        <span>
                            <span class="block text-sm font-bold text-slate-900"><?php echo e($nama); ?></span>
                            <span class="block text-xs text-slate-400 mt-0.5"><?php echo e($peran); ?></span>
                        </span>
                    </figcaption>
                </figure>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6">
        ...
        <div class="space-y-3" x-data="{ openFaq: 0 }">
            <?php $__currentLoopData = $faqs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $i => $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="bg-white rounded-2xl border transition-all duration-200 overflow-hidden" :class="openFaq === <?php echo e($i); ?> ? 'border-[#111111]/40 shadow-[0_12px_30px_-12px_rgba(0,0,0,0.3)]' : 'border-slate-200/80 hover:border-slate-300'">
                    <button @click="openFaq = openFaq === <?php echo e($i); ?> ? -1 : <?php echo e($i); ?>" class="w-full flex items-center justify-between gap-4 px-5 sm:px-6 py-4 text-left">
                        <span class="text-sm sm:text-[15px] font-bold text-slate-800"><?php echo e($f['question']); ?></span>
                        <span class="w-8 h-8 shrink-0 rounded-full flex items-center justify-center transition-all" :class="openFaq === <?php echo e($i); ?> ? 'bg-[#111111] text-white rotate-45' : 'bg-slate-100 text-slate-500'">
                    ...
                    <div x-show="openFaq === <?php echo e($i); ?>" x-collapse>
                        <p class="px-5 sm:px-6 pb-5 text-sm text-slate-500 leading-relaxed"><?php echo e($f['answer']); ?></p>
                    </div>
                </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
