...
<?php $__env->startSection('title', 'Pembayaran Layanan'); ?>
...
<div class="min-h-[calc(100vh-5rem)] flex flex-col justify-center p-4 sm:p-6">
    <div class="mx-auto w-full max-w-2xl">
        ...
        <div class="card bg-white shadow-md mb-4">
            <div class="p-5">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <div class="mb-3">
                            <small class="text-[#6e6e73] block">Layanan</small>
                            <h5 class="font-bold text-[#0071e3]"><?php echo e($booking->layanan->nama_layanan); ?></h5>
                        </div>
                        <div class="mb-3">
        ...
        data-success-url="<?php echo e(route('customer.layanan.booking.success', $booking->id)); ?>"
        data-check-url="<?php echo e(route('customer.layanan.check-status', $booking->id)); ?>"
        data-fallback-url="<?php echo e(route('customer.layanan.my-bookings')); ?>">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 me-2 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    <?php else: ?>
                        ...
                        <div class="mb-4">
                            <a href="<?php echo e(route('customer.layanan.payment', $booking->id)); ?>" class="btn-dark-apple btn-lg w-full md:w-auto md:px-8">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 me-2 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="hidden md:block overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <h6 class="mb-1 font-semibold"><?php echo e($booking->layanan->nama_layanan); ?></h6>
                                    <small class="text-[#6e6e73]">
                                        <?php echo e($booking->tipe_booking_label); ?>

                                        <?php if($booking->paketLayanan): ?>
                                            - <?php echo e($booking->paketLayanan->nama_paket); ?>
                ...
                <div class="md:hidden space-y-3">
                    <div class="bg-[#f5f5f7] rounded-lg p-3">
                        <div class="flex items-start gap-3">
                            <div class="shrink-0">
                                <?php if($booking->layanan->gambar_utama): ?>
                                    <img src="<?php echo e(asset('storage/' . $booking->layanan->gambar_utama)); ?>"
                                         alt="<?php echo e($booking->layanan->nama_layanan); ?>"
                                ...
                                <?php else: ?>
                                    <div class="bg-white rounded flex items-center justify-center w-16 h-16">
                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6 text-[#6e6e73]" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                            <path stroke-linecap="round" stroke-lineflex="round" d="M21 15a2 2 0 01-2 2H7l-4 4V5a2 2 0 012-2h14a2 2 0 012 2z" />
                                        </svg>
                                    </div>
                                <?php endif; ?>
                            </div>
                            <div class="flex-1 min-w-0">
                                <h6 class="font-semibold text-sm leading-snug"><?php echo e($booking->layanan->nama_layanan); ?></h6>
        ...
        <div class="mt-4 flex justify-center">
            <a href="<?php echo e(route('customer.layanan.my-bookings')); ?>"
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\customer\layanan\payment.blade.php ENDPATH**/ ?>