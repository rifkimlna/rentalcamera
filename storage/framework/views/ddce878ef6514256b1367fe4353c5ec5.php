...
<?php $__env->startSection('page-title', $layanan->nama_layanan); ?>
        ...
        <div class="bg-white rounded-2xl border border-[#f0f0f2]">
            <div class="p-5">
                <?php if($layanan->gambar_utama): ?>
                    <img src="<?php echo e(asset('storage/' . $layanan->gambar_utama)); ?>" alt="<?php echo e($layanan->nama_layanan); ?>" class="w-full rounded mb-3">
                <?php endif; ?>
                <h5 class="font-medium"><?php echo e($layanan->nama_layanan); ?></h5>
                <?php if($layanan->kategori): ?>
                    <p class="text-sm text-[#6e6e73]">Kategori: <?php echo e($layanan->kategori); ?></p>
                <?php endif; ?>
                <p class="text-sm text-[#6e6e73]"><?php echo e($layanan->harga_mulai_formatted); ?> / mulai</p>
                <span class="badge <?php echo e($layanan->status == 'active' ? 'badge-success' : 'badge-apple'); ?>"><?php echo e($layanan->status); ?></span>
                <p class="text-sm mt-2">Total Booking: <?php echo e($layanan->bookings_count); ?></p>
            </div>
        </div>
    </div>
    <div class="lg:col-span-2">
        <div class="bg-white rounded-2xl border border-[#f0f0f2]">
            <div class="p-5">
                ...
                <p class="text-sm"><?php echo e($layanan->deskripsi ?? 'Tidak ada deskripsi.'); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border border-[#f0f0f2] mt-4">
            <div class="p-5">
                ...
                <?php $__empty_1 = true; $__currentLoopData = $layanan->paketActive; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $paket): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\layanan\show.blade.php ENDPATH**/ ?>