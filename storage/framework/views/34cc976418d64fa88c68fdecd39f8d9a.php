<?php $__env->startSection('title', 'Booking Layanan'); ?>
<?php $__env->startSection('page-title', 'Booking Layanan'); ?>
    ...
    <div class="py-3 px-4">
        <form method="GET" class="flex flex-wrap gap-x-3 gap-y-2 items-end">
            <div class="flex-1 min-w-[200px]">
                ...
                <input type="text" name="search" class="input-apple input-sm w-full" placeholder="Nama user atau layanan..." value="<?php echo e(request('search')); ?>">
            </div>
            <div>
                ...
                <select name="layanan_id" class="select-apple !text-sm">
                    ...
                    <?php $__currentLoopData = $layanans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($l->id); ?>" <?php echo e(request('layanan_id') == $l->id ? 'selected' : ''); ?>><?php echo e($l->nama_layanan); ?></option>
            ...
            <div class="flex gap-1">
                ...
                <a href="<?php echo e(route('admin.layanan.bookings')); ?>" class="btn-dark-apple !text-sm !px-3 !py-1.5">Reset</a>
            </div>
        </form>
    </div>
</div>
            ...
            <table class="w-full text-sm">
                ...
                <tbody>
                    ...
                    <tr class="hover:bg-[#f5f5f7]/50">
                        ...
                        <td>
                            <div class="text-sm"><?php echo e($booking->layanan->nama_layanan ?? '-'); ?></div>
                        ...
                        <td>
                            <form method="POST" action="<?php echo e(route('admin.layanan.booking.update-status', $booking->id)); ?>" class="flex gap-1">
                                ...
                                <?php endif; ?>
                                <a href="<?php echo e(route('admin.layanan.booking.print', $booking->id)); ?>" class="text-[#6e6e73] hover:bg-[#f5f5f7] rounded-xl !text-[10px] !px-2 !py-0.5 transition-colors" target="_blank" title="Cetak Struk">Cetak</a>
                            </form>
                        </td>
                    </tr>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\layanan\bookings.blade.php ENDPATH**/ ?>