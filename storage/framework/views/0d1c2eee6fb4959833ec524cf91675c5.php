...
<div class="space-y-4">
    <div class="flex items-center gap-2 justify-between">
        <div class="flex gap-1">
            <a href="<?php echo e(request()->fullUrlWithQuery(['filter' => 'all'])); ?>" class="<?php echo e(request('filter', 'all') === 'all' ? 'btn-dark-apple !text-sm !px-3 !py-1.5' : 'btn-outline-apple !text-sm !px-3 !py-1.5'); ?>">Semua</a>
            <a href="<?php echo e(request()->fullUrlWithQuery(['filter' => 'unread'])); ?>" class="<?php echo e(request('filter') === 'unread' ? 'btn-dark-apple !text-sm !px-3 !py-1.5' : 'btn-outline-apple !text-sm !px-3 !py-1.5'); ?>">Belum Dibaca</a>
        </div>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2 mt-2">
                        <span class="inline-flex items-center px-2 py-0.5 rounded-full text-[10px] font-medium border border-[#e5e5e7] text-[#6e6e73]"><?php echo e($notification->type_label); ?></span>
...
<?php echo $__env->make($isAdmin ? 'layouts.admin' : 'layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\notifications\index.blade.php ENDPATH**/ ?>