<?php $__env->startSection('title', 'Paket Studio - ' . $studio->nama_studio); ?>
<?php $__env->startSection('page-title', 'Paket: ' . $studio->nama_studio); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-white rounded-2xl border border-[#f0f0f2]">
    <div class="p-5">
        <div class="flex justify-between items-center mb-4">
            <a href="<?php echo e(route('admin.studio.show', $studio->id)); ?>" class="text-[#6e6e73] hover:bg-[#f5f5f7] rounded-xl !text-sm !px-3 !py-1.5 transition-colors">Kembali ke Detail</a>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\studio\paket_index.blade.php ENDPATH**/ ?>