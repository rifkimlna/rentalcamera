<?php $__env->startSection('title', 'Keranjang - Stekpro Multimedia & Broadcast'); ?>
<?php $__env->startSection('page-title', 'Keranjang Saya'); ?>
...
<div>
    <div class="flex items-center justify-between mb-4">
        ...
        <div>
            <a href="<?php echo e(route('customer.products.index')); ?>" class="btn-outline-apple">
                ...
                <div class="card-apple-static">
                    <div class="p-5">
                            ...
                            <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="bg-white border border-[#f0f0f2] rounded-xl p-3">
                                    <div class="flex items-start gap-3">
                                        <?php if($item->produk && $item->produk->gambar_utama): ?>
                                            <img src="<?php echo e(asset('storage/' . $item->produk->gambar_utama)); ?>" alt="<?php echo e($item->produk->nama_produk); ?>" class="w-14 h-14 rounded-xl object-cover shrink-0" onerror="this.onerror=null;this.style.display='none';this.nextElementSibling.classList.remove('hidden')">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            <h6 class="text-sm font-semibold truncate"><?php echo e(optional($item->produk)->nama_produk ?? 'Produk tidak tersedia'); ?></h6>
                                            <p class="text-xs text-[#6e6e73]"><?php echo e(optional(optional($item->produk)->kategori)->nama_kategori ?? ''); ?></p>
                                            <p class="text-xs text-[#6e6e73]">
                                                <?php echo e(\Carbon\Carbon::parse($item->tanggal_sewa)->format('d M')); ?> - <?php echo e(\Carbon\Carbon::parse($item->tanggal_kembali)->format('d M')); ?> (<?php echo e($item->lama_sewa); ?> hari)
                                            </p>
                                            <p class="text-sm font-bold text-[#0071e3] mt-1">Rp <?php echo e(number_format($itemSubtotal, 0, ',', '.')); ?></p>
                                        </div>
                                        <form action="<?php echo e(route('customer.cart.destroy', $item->id)); ?>" method="POST" class="delete-form">
                                            <?php echo csrf_field(); ?>
                                    ...
                                    <div class="flex items-center justify-between mt-2 pt-2 border-t border-[#f0f0f2]">
                                        <form action="<?php echo e(route('customer.cart.update', $item->id)); ?>" method="POST" class="flex items-center gap-2">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PUT'); ?>
                                            <span class="text-xs text-[#6e6e73]">Jumlah:</span>
                                            <input type="number" class="input-apple w-16 text-center text-xs" name="jumlah" value="<?php echo e($item->jumlah); ?>" min="1" max="<?php echo e(optional($item->produk)->stok_tersedia ?? 0); ?>">
                                        ...
                                        <span class="text-xs text-[#6e6e73]"><?php echo e($item->jumlah); ?>x Rp <?php echo e(number_format($hargaPerHari, 0, ',', '.')); ?>/hari</span>
                                    </div>
                                </div>
                                    ...
                                    <?php $__currentLoopData = $cartItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="border-t border-[#f0f0f2]">
                                            <td class="py-3 px-2">
                                                <?php if($item->produk && $item->produk->gambar_utama): ?>
                                                    <div class="relative">
                                                        <img src="<?php echo e(asset('storage/' . $item->produk->gambar_utama)); ?>" alt="<?php echo e($item->produk->nama_produk); ?>" class="rounded-xl w-12 h-12 object-cover" onerror="this.onerror=null;this.style.display='none';this.nextElementSibling.classList.remove('hidden')">
                                            ...
                                            <td class="py-3 px-2">
                                                <h6 class="mb-1"><?php echo e(optional($item->produk)->nama_produk ?? 'Produk tidak tersedia'); ?></h6>
                                                <small class="text-[#6e6e73]"><?php echo e(optional($item->produk)->brand?->nama_brand ?? ''); ?></small>
                                            </td>
                                            <td class="text-center py-3 px-2">
                                                <small><?php echo e(\Carbon\Carbon::parse($item->tanggal_sewa)->format('d M')); ?></small>
                                                <div class="text-xs text-[#6e6e73]">s/d</div>
                                                <small><?php echo e(\Carbon\Carbon::parse($item->tanggal_kembali)->format('d M')); ?></small>
                                                <div class="text-xs text-[#0071e3]"><?php echo e($item->lama_sewa); ?> hari</div>
                                            </td>
                                            <td class="text-center py-3 px-2">
                                                <form action="<?php echo e(route('customer.cart.update', $item->id)); ?>" method="POST" class="inline">
                                            ...
                                            <td class="text-right py-3 px-2">
                                                <div>Rp <?php echo e(number_format(optional($item->produk)->harga_per_hari ?? 0, 0, ',', '.')); ?></div>
                                                <small class="text-[#6e6e73]">per hari</small>
                                            </td>
                                            <td class="text-right py-3 px-2">
                                                <?php $itemSubtotal = (optional($item->produk)->harga_per_hari ?? 0) * $item->lama_sewa * $item->jumlah; ?>
                                                <div class="text-[#0071e3]"><strong>Rp <?php echo e(number_format($itemSubtotal, 0, ',', '.')); ?></strong></div>
                                            </td>
                                            <td class="py-3 px-2">
                                                <form action="<?php echo e(route('customer.cart.destroy', $item->id)); ?>" method="POST" class="delete-form">
                        ...
                        <div class="flex items-center justify-between mt-4">
                            <form action="<?php echo e(route('customer.cart.clear')); ?>" method="POST" class="delete-form">
                                <?php echo csrf_field(); ?>
                            ...
                            <div class="text-[#6e6e73] text-sm"><?php echo e($cartItems->count()); ?> produk di keranjang</div>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="p-5">
                        ...
                        <div class="space-y-3">
                            ...
                            <div class="flex justify-between font-bold">
                                <span>Total</span>
                                <span class="text-[#0071e3]">Rp <?php echo e(number_format($subtotal, 0, ',', '.')); ?></span>
                            </div>
                            <a href="<?php echo e(route('customer.checkout.index')); ?>" class="btn-dark-apple w-full mt-2">
    ...
    <?php else: ?>
        <div class="card-apple-static">
            <div class="p-5 text-center py-8">
                ...
                <a href="<?php echo e(route('customer.products.index')); ?>" class="btn-dark-apple">Sewa Kamera Sekarang</a>
            </div>
        </div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views/customer/cart/index.blade.php ENDPATH**/ ?>