...
<?php $__env->startSection('title', 'Booking Studio Saya'); ?>
<?php $__env->startSection('page-title', 'Booking Studio Saya'); ?>
...
<div class="space-y-4">
    <div class="flex flex-col sm:flex-row gap-3 items-start sm:items-center justify-between">
        ...
        <a href="<?php echo e(route('customer.studio.index')); ?>" class="btn-dark-apple btn-sm">
                ...
                <div class="p-4">
                    <div class="flex items-start gap-4">
                        ...
                        <div class="shrink-0 w-16 h-16 rounded-lg overflow-hidden bg-[#f5f5f7] hidden sm:block">
                            <?php if($imgUrl): ?>
                                <img src="<?php echo e($imgUrl); ?>" class="w-full h-full object-cover" alt="<?php echo e($booking->studio->nama_studio); ?>">
                            <?php else: ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-2">
                                <div class="min-w-0">
                                    <h4 class="text-sm font-medium"><?php echo e($booking->studio->nama_studio); ?></h4>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-2">
                                <span class="text-xs text-[#6e6e73]">
                                    ...
                                    <?php if($booking->paketStudio): ?>
                                        &middot; <?php echo e($booking->paketStudio->nama_paket); ?>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-3">
                                <?php if($isPending): ?>
                                    <a href="<?php echo e(route('customer.studio.payment', $booking->id)); ?>" class="btn-dark-apple btn-xs">
                                    ...
                                    <form method="POST" action="<?php echo e(route('customer.studio.booking.cancel', $booking->id)); ?>" class="inline" onsubmit="return confirm('Batalkan booking ini?')">
        ...
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
            <div class="card bg-white border border-[#e5e5e7]">
                <div class="p-5 text-center py-12">
                    ...
                    <a href="<?php echo e(route('customer.studio.index')); ?>" class="btn-dark-apple btn-sm">Lihat Studio</a>
                </div>
            </div>
        <?php endif; ?>
    </div>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\customer\studio\my_bookings.blade.php ENDPATH**/ ?>