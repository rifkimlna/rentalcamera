...
<div>
    <div class="mb-6">
        ...
        <p class="text-[#6e6e73]">Ringkasan bisnis bulan <?php echo e(Carbon\Carbon::now()->locale('id')->isoFormat('MMMM YYYY')); ?></p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
        <div class="bg-white rounded-2xl border border-[#f0f0f2] p-5">
            ...
            <div class="text-2xl font-bold text-[#0071e3]">Rp <?php echo e(number_format($totalRevenue, 0, ',', '.')); ?></div>
        ...
        <div class="bg-white rounded-2xl border border-[#f0f0f2] p-5">
            ...
            <div class="text-2xl font-bold text-[#34c759]"><?php echo e(number_format($totalOrders, 0, ',', '.')); ?></div>
        ...
        <div class="bg-white rounded-2xl border border-[#f0f0f2] p-5">
            ...
            <div class="text-2xl font-bold text-[#0071e3]"><?php echo e(number_format($totalCustomers, 0, ',', '.')); ?></div>
        ...
        <div class="bg-white rounded-2xl border border-[#f0f0f2] p-5">
            ...
            <div class="text-2xl font-bold text-[#ff9500]"><?php echo e(number_format($totalProducts, 0, ',', '.')); ?></div>
            <div class="text-xs text-[#86868b]">Total Produk</div>
            <div class="text-xs text-[#86868b]"><?php echo e($availableProducts); ?> tersedia</div>
        </div>
    </div>
    ...
    <div class="bg-white rounded-2xl border border-[#f0f0f2]">
        <div class="p-5">
            <div class="flex justify-between items-center mb-3">
                ...
                <a href="<?php echo e(route('admin.transactions.index')); ?>" class="text-[#6e6e73] hover:bg-[#f5f5f7] rounded-xl !text-sm !px-3 !py-1.5 transition-colors">Lihat Semua</a>
            </div>
            <div class="overflow-x-auto">
                <table class="w-full text-sm">
                    ...
                    <tbody>
                        ...
                        <tr class="hover">
                            <td><strong><?php echo e($t->kode_transaksi); ?></strong></td>
                            <td>
                                <div><?php echo e($t->nama_customer); ?></div>
                                <div class="text-xs opacity-60"><?php echo e($t->email_customer); ?></div>
                            </td>
                            <td><strong>Rp <?php echo e(number_format($t->grand_total, 0, ',', '.')); ?></strong></td>
                            <td>
                                <?php if($t->status_pembayaran == 'settlement'): ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views/admin/dashboard/index.blade.php ENDPATH**/ ?>