<?php $__env->startSection('title', 'Sewa Kamera - Stekpro Multimedia & Broadcast'); ?>
...
<div id="productsPage"
    ...
    <div class="card-apple-static p-3 sm:p-4 lg:p-5 mb-4 sm:mb-6">
        <form method="GET" action="<?php echo e(route('customer.products.index')); ?>">
            ...
            <div class="hidden lg:grid lg:grid-cols-6 gap-4">
                <div class="col-span-2">
                    ...
                    <input type="text" class="input-apple" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari produk...">
                </div>
                <div>
                    ...
                    <select class="select-apple" name="kategori">
                        ...
                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($category->slug); ?>" <?php echo e(request('kategori') == $category->slug ? 'selected' : ''); ?>><?php echo e($category->nama_kategori); ?></option>
                ...
                <div class="flex items-end gap-2">
                    ...
                    <a href="<?php echo e(route('customer.products.index')); ?>" class="btn-outline-apple !px-3 !py-2.5">
            ...
            <div class="lg:hidden space-y-3">
                <div class="flex items-center gap-2">
                    <div class="relative flex-1">
                        ...
                        <input type="text" class="input-apple !pl-9" name="search" value="<?php echo e(request('search')); ?>" placeholder="Cari produk...">
                    </div>
    ...
    <?php $__empty_1 = true; $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        <?php echo $__env->make('customer.products._product_card', ['product' => $product], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <div class="col-span-full card-apple-static p-12 text-center">
            ...
            <a href="<?php echo e(route('customer.products.index')); ?>" class="btn-outline-apple !px-5 !py-2 !text-sm">Reset Pencarian</a>
        </div>
    <?php endif; ?>
    </div>
    ...
    <div class="mt-12 card-apple-static p-6 lg:p-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(route('customer.products.index', ['kategori' => $category->slug])); ?>" class="group flex flex-col items-center p-4 rounded-2xl hover:bg-[#f5f5f7] transition-colors">
                    <div class="w-12 h-12 rounded-2xl bg-[#f5f5f7] flex items-center justify-center mb-3 group-hover:bg-[#e5e5e7] transition-colors">
                        ...
                        ?>
                        <?php echo $icons[$category->slug] ?? $icons['kamera-dslr']; ?>
...
<?php echo $__env->make('layouts.customer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views/customer/products/index.blade.php ENDPATH**/ ?>