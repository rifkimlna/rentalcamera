...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'Admin - Stekpro Multimedia & Broadcast'); ?></title>
        ...
        <aside :class="sidebarOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'" class="fixed top-0 left-0 bottom-0 w-64 bg-white border-r border-[#e5e5e7] z-50 transition-transform duration-200 ease-out overflow-y-auto flex flex-col lg:sticky lg:top-0 lg:h-screen">
            ...
            <div class="px-5 py-5 border-b border-[#f0f0f2]">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-2.5">
                    <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Stekpro Logo" class="h-8 w-auto object-contain">
                    <div>
            ...
            <nav class="flex-1 px-3 py-4">
                <ul class="space-y-0.5">
                    <li>
                        <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.dashboard*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.transactions.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.transactions*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.products.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.products*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.studio.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.studio*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                            <svg class="w-[18px] h-[18px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"/></svg>
                            Studio
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.layanan.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.layanan*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                ...
                <ul class="space-y-0.5">
                    <li>
                        <a href="<?php echo e(route('admin.users.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.users*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                            <svg class="w-[18px] h-[18px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197m13.5-9a2.5 2.5 0 11-5 0 2.5 2.5 0 015 0z"/></svg>
                            Pengguna
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.reports.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.reports*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                            <svg class="w-[18px] h-[18px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"/></svg>
                            Laporan
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.vouchers.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.vouchers*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.reviews.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.reviews*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                    ...
                    <li>
                        <a href="<?php echo e(route('admin.portfolios.index')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.portfolios*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                            <svg class="w-[18px] h-[18px] shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5"><path stroke-linecap="round" stroke-linejoin="round" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 012-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"/></svg>
                            Portfolio
                        </a>
                    </li>
                    <li>
                        <a href="<?php echo e(route('admin.activity-logs')); ?>" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl transition-colors <?php echo e(request()->routeIs('admin.activity-logs*') ? 'bg-[#f5f5f7] font-medium text-[#1d1d1f]' : 'text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f]'); ?>">
                ...
                <ul class="space-y-0.5">
                    <li>
                        <a href="<?php echo e(route('home')); ?>" target="_blank" class="flex items-center gap-3 px-3 py-2.5 text-sm rounded-xl text-[#6e6e73] hover:bg-[#f5f5f7] hover:text-[#1d1d1f] transition-colors">
        ...
        <div class="flex-1 min-w-0 flex flex-col">
            ...
            <header class="sticky top-0 z-30 bg-white/80 backdrop-blur-xl border-b border-[#f0f0f2]">
                <div class="flex items-center h-12 px-4">
                    ...
                    <div class="flex-1">
                        <span class="text-sm font-semibold text-[#1d1d1f]"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></span>
                    </div>
                    <div class="flex items-center gap-2">
                        <a href="<?php echo e(route('notifications')); ?>" class="relative p-2 -mr-1">
                            ...
                            <?php $notifCount = Auth::user()->notifications()->where('is_read', false)->count(); ?>
                            <?php if($notifCount > 0): ?>
                        ...
                        <div class="hidden lg:flex items-center gap-2">
                            ...
                            <span class="text-xs text-[#6e6e73]"><?php echo e(Auth::user()->nama); ?></span>
                        </div>
                    </div>
                </div>
            </header>
...
<?php /**PATH C:\laragon\www\PROJECT KP\resources\views\layouts\admin.blade.php ENDPATH**/ ?>