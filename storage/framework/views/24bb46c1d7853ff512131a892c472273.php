<?php $__env->startSection('title', 'Tambah Voucher - Stekpro Multimedia & Broadcast'); ?>
...
unset($__errorArgs, $__bag); ?>"
                                   id="kode_voucher" name="kode_voucher" value="<?php echo e(old('kode_voucher')); ?>"
...
unset($__errorArgs, $__bag); ?>"
                               id="nama_voucher" name="nama_voucher" value="<?php echo e(old('nama_voucher')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                            ...
                            <option value="fixed" <?php echo e(old('type') == 'fixed' ? 'selected' : ''); ?>>Nominal</option>
...
unset($__errorArgs, $__bag); ?>"
                               id="min_purchase" name="min_purchase" value="<?php echo e(old('min_purchase', 0)); ?>">
...
unset($__errorArgs, $__bag); ?>"
                               id="kuota" name="kuota" value="<?php echo e(old('kuota')); ?>"
                               placeholder="Kosongkan jika tanpa batas">
                    ...
                    <div>
                        ...
                        <select class="select-apple w-full" id="produk_id" name="produk_id">
                            ...
                            <?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($product->id); ?>" <?php echo e(old('produk_id') == $product->id ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\vouchers\create.blade.php ENDPATH**/ ?>