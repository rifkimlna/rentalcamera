            ...
            <div class="card-apple overflow-hidden hover:shadow-md hover:-translate-y-px transition-all duration-300">
                <div class="p-3.5 sm:p-5">
                    <div class="flex items-start gap-3 sm:gap-4">
                        ...
                        <a href="<?php echo e($transaction->detail_link); ?>" class="shrink-0 w-14 h-14 sm:w-20 sm:h-20 rounded-xl sm:rounded-2xl overflow-hidden bg-[#f5f5f7]" aria-hidden="true" tabindex="-1">
                            <?php if($itemImage): ?>
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1 flex items-center gap-x-1.5 text-xs text-[#86868b] truncate">
                                        <span class="hidden sm:inline font-medium text-[#6e6e73]"><?php echo e($transaction->tipe_label); ?><span class="mx-1" aria-hidden="true">&middot;</span></span>
                                        <span class="font-mono truncate"><?php echo e($transaction->kode); ?></span>
                                        <span aria-hidden="true">&middot;</span>
                                        <span class="shrink-0"><?php echo e($createdAt); ?></span>
                                    </p>
                                </div>
                                <div class="text-right shrink-0">
                                    <p class="text-sm sm:text-lg font-bold text-[#1d1d1f] tracking-tight">Rp <?php echo e(number_format($transaction->total ?? 0, 0, ',', '.')); ?></p>
                                </div>
                            </div>
                            ...
                            <div class="mt-2 sm:mt-2.5 pt-2 border-t border-[#f5f5f7] flex flex-wrap items-center justify-between gap-2">
                                ...
                                <div class="flex items-center gap-1.5 sm:gap-2 ml-auto">
                                    <a href="<?php echo e($transaction->detail_link); ?>" class="inline-flex items-center justify-center text-xs font-medium px-4 py-2 rounded-lg lg:rounded-xl bg-[#1d1d1f] text-white hover:bg-[#333] transition-colors">
                                        Detail
                                    </a>
