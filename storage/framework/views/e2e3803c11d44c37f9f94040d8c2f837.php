<?php $__env->startSection('title', 'Tambah Paket - ' . $studio->nama_studio); ?>
<?php $__env->startSection('page-title', 'Tambah Paket: ' . $studio->nama_studio); ?>

<?php $__env->startSection('content'); ?>
<div class="bg-white rounded-2xl border border-[#f0f0f2] max-w-2xl">
    <div class="p-5">
        <form method="POST" action="<?php echo e(route('admin.studio.paket.store', $studio->id)); ?>" enctype="multipart/form-data">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="mb-3">
                ...
                <textarea name="include_alat" class="input-apple resize-none w-full" rows="3" placeholder="Mic, Kamera, Lighting, ..."><?php echo e(old('include_alat')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\PROJECT KP\resources\views\admin\studio\paket_create.blade.php ENDPATH**/ ?>