<div class="inline-flex items-center gap-0">
    ...
    @if(isset($showNumber) && $showNumber)
        <span class="ml-1 text-base-content/60 text-sm">({{ number_format($rating, 1) }})</span>
    @endif
    
    @if(isset($showCount) && $showCount && isset($count))
        <span class="ml-1 text-base-content/60 text-sm">({{ $count }} ulasan)</span>
    @endif
</div>
