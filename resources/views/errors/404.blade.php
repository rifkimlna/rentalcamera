...
<body class="font-sans bg-white min-h-screen flex items-center justify-center">
    <div class="relative flex flex-col w-full justify-center min-h-screen p-6 md:p-10">
        <div class="relative max-w-5xl mx-auto w-full">
            {{-- Watermark 404 ala Illustration (hitam 4% opacity) --}}
            ...
            <div class="relative text-center z-[1]">
                ...
                <form action="{{ route('customer.products.index') }}" method="GET" class="mt-10 flex flex-col sm:flex-row gap-2 mx-auto sm:max-w-sm">
                ...
                <div class="mt-10 flex flex-col sm:flex-row sm:items-center sm:justify-center gap-3">
                    ...
                    <a href="{{ route('home') }}" class="inline-flex items-center justify-center whitespace-nowrap rounded-full bg-black px-4 h-10 text-sm font-medium text-white hover:bg-neutral-800 transition-colors">Ke beranda</a>
                </div>
            </div>
        </div>
    </div>
