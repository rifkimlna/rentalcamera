    ...
    <div class="w-full max-w-md">
            <div class="card bg-base-100 shadow-md">
                <div class="card-body p-5">
                    <div class="text-center mb-4">
                        ...
                        <p class="text-base-content/60">Masuk ke akun Anda</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="text-center">
                            <p class="mb-0">Belum punya akun? 
                                <a href="{{ route('register') }}" class="no-underline text-primary">Daftar di sini</a>
                            </p>
                            <p class="mt-2">
                    ...
                    <div class="text-center">
                        <h6 class="text-base-content/60">Login dengan</h6>
                        <div class="flex justify-center gap-3 mt-3">
                            <a href="{{ route('auth.google') }}" class="btn btn-outline btn-primary">
                            ...
                            <button class="btn btn-outline">
                                <svg class="w-4 h-4" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" fill="#1877F2">
            ...
            <div class="text-center mt-4">
                <p class="text-base-content/60 text-sm">
                    &copy; {{ date('Y') }} Sewa Kamera Pro. All rights reserved.<br>
                    <a href="#" class="no-underline text-primary">Terms of Service</a> &bull; 
