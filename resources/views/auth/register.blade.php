        ...
        <div class="bg-white rounded-2xl border border-[#f0f0f2] p-8 sm:p-10">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-0">
                    <div class="mb-4">
                        <input type="text"
                               class="input-apple w-full @error('nama') text-[#d70015] border-[#d70015] @enderror"
                    ...
                    <div class="mb-4">
                        <input type="tel"
                               class="input-apple w-full @error('telepon') text-[#d70015] border-[#d70015] @enderror"
                    ...
                    <div class="mb-4">
                        <select class="input-apple w-full @error('jenis_kelamin') text-[#d70015] border-[#d70015] @enderror"
                ...
                <div class="mb-4">
                    <textarea class="input-apple w-full @error('alamat') text-[#d70015] border-[#d70015] @enderror"
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-0">
                    <div class="mb-4">
                        <input type="text"
                               class="input-apple w-full @error('kota') text-[#d70015] border-[#d70015] @enderror"
                    ...
                    <div class="mb-4">
                        <input type="text"
                               class="input-apple w-full @error('provinsi') text-[#d70015] border-[#d70015] @enderror"
                ...
                <div class="mb-4">
                    <input type="date"
                           class="input-apple w-full @error('tanggal_lahir') text-[#d70015] border-[#d70015] @enderror"
                ...
                <label class="flex items-start gap-2 mb-4 cursor-pointer">
                    <input type="checkbox" class="w-4 h-4 rounded border-[#d1d5db] text-[#0071e3] focus:ring-[#0071e3] mt-0.5 @error('agree_terms') text-[#d70015] border-[#d70015] @enderror"
                ...
                @error('agree_terms')
                    <span class="text-[#d70015] text-xs block mb-3">{{ $message }}</span>
                @enderror
                ...
                <div class="text-center text-sm">
                    ...
                    <a href="{{ route('login') }}" class="text-[#1d1d1f] font-medium hover:underline">Masuk</a>
                </div>
            </form>
        </div>
