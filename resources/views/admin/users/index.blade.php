...
<div>
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('admin.users.create') }}" class="btn-dark-apple">
            ...
            <form method="GET" action="{{ route('admin.users.index') }}" class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <div class="flex w-full">
                        <input type="text" name="search" class="input-apple flex-1" value="{{ request('search') }}" placeholder="Nama, email, atau telepon...">
                ...
                <div class="flex items-end">
                    <a href="{{ route('admin.users.index') }}" class="text-[#6e6e73] hover:bg-[#f5f5f7] rounded-xl px-3 py-2 text-sm transition-colors w-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-2">
                                <div class="bg-[#f5f5f7] rounded-full flex items-center justify-center w-8 h-8">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-[#6e6e73]" viewBox="0 0 24 24" fill="currentColor"><path fill-rule="evenodd" d="M7.5 6a4.5 4.5 0 119 0 4.5 4.5 0 01-9 0zM3.751 20.105a8.25 8.25 0 0116.498 0 .75.75 0 01-.437.695A18.683 18.683 0 0112 22.5c-2.786 0-5.433-.608-7.812-1.7a.75.75 0 01-.437-.695z" clip-rule="evenodd"/></svg>
                                </div>
                                <div>
                        ...
                        <td class="text-center">
                            ...
                            @endphp
                            <span class="badge {{ $roleConfig[$user->role] ?? 'badge-apple' }}">
                        ...
                        <td class="text-center">
                            ...
                            @endphp
                            <span class="badge {{ $statusConfig[$user->status] ?? 'badge-apple' }}">
                                {{ $statuses[$user->status] ?? $user->status }}
                            </span>
                        </td>
                        <td class="text-center">
                            <div class="flex gap-2 justify-center">
                                <a href="{{ route('admin.users.show', $user->id) }}" class="text-[#6e6e73] hover:bg-[#f5f5f7] rounded-xl !text-sm !px-3 !py-1.5 transition-colors" title="Lihat Detail">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"/></svg>
                                </a>
                                <a href="{{ route('admin.users.edit', $user->id) }}" class="text-[#6e6e73] hover:bg-[#f5f5f7] rounded-xl !text-sm !px-3 !py-1.5 transition-colors text-[#ff9500]" title="Edit">
