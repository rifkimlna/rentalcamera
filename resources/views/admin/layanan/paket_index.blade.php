...
@section('title', 'Paket Layanan - ' . $layanan->nama_layanan)
@section('page-title', 'Paket: ' . $layanan->nama_layanan)

@section('content')
<div class="bg-white rounded-2xl border border-[#f0f0f2]">
    <div class="p-5">
        <div class="flex justify-between items-center mb-4">
            <a href="{{ route('admin.layanan.show', $layanan->id) }}" class="text-[#6e6e73] hover:bg-[#f5f5f7] rounded-xl !text-sm !px-3 !py-1.5 transition-colors">Kembali ke Detail</a>
