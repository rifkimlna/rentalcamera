    ...
    <div class="p-5">
        <form method="POST" action="{{ route('admin.layanan.update', $layanan->id) }}" enctype="multipart/form-data">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="nama_layanan" class="input-apple w-full" value="{{ old('nama_layanan', $layanan->nama_layanan) }}" required>
            ...
            <div class="mb-3">
                ...
                <textarea name="deskripsi" class="input-apple resize-none w-full" rows="4">{{ old('deskripsi', $layanan->deskripsi) }}</textarea>
            ...
            <div class="mb-3">
                ...
                <select name="kategori" class="select-apple w-full">
                    ...
                    <option value="Prewedding" {{ old('kategori', $layanan->kategori) == 'Prewedding' ? 'selected' : '' }}>Prewedding</option>
                    <option value="Wedding" {{ old('kategori', $layanan->kategori) == 'Wedding' ? 'selected' : '' }}>Wedding</option>
                    <option value="Live Streaming" {{ old('kategori', $layanan->kategori) == 'Live Streaming' ? 'selected' : '' }}>Live Streaming</option>
                    <option value="Videografi" {{ old('kategori', $layanan->kategori) == 'Videografi' ? 'selected' : '' }}>Videografi</option>
                    <option value="Dokumentasi Event" {{ old('kategori', $layanan->kategori) == 'Dokumentasi Event' ? 'selected' : '' }}>Dokumentasi Event</option>
                    <option value="Fotobooth" {{ old('kategori', $layanan->kategori) == 'Fotobooth' ? 'selected' : '' }}>Fotobooth</option>
                    <option value="Drone" {{ old('kategori', $layanan->kategori) == 'Drone' ? 'selected' : '' }}>Drone</option>
                </select>
            ...
            <div class="mb-3">
                ...
                <input type="number" name="harga_mulai" class="input-apple w-full" value="{{ old('harga_mulai', $layanan->harga_mulai) }}" required>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="ikon" class="input-apple w-full" value="{{ old('ikon', $layanan->ikon) }}" placeholder="📸">
            ...
            <div class="mb-3">
                ...
                @if($layanan->gambar_utama)
                    <div class="mb-2">
                        <img src="{{ asset('storage/' . $layanan->gambar_utama) }}" alt="{{ $layanan->nama_layanan }}" class="w-24 h-24 object-cover rounded">
                    </div>
                @endif
