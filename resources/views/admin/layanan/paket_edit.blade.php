...
<div class="bg-white rounded-2xl border border-[#f0f0f2] max-w-2xl">
    <div class="p-5">
        <form method="POST" action="{{ route('admin.layanan.paket.update', [$layanan->id, $paket->id]) }}" enctype="multipart/form-data">
            @csrf @method('PUT')
            ...
            <div class="mb-3">
                ...
                <textarea name="include" class="input-apple resize-none w-full" rows="3" placeholder="Kamera, Videografer, Editor, ...">{{ old('include', $paket->include) }}</textarea>
