...
<div class="card bg-base-100 shadow-md">
    <div class="card-body">
        <div class="flex justify-between items-center mb-4">
            <a href="{{ route('admin.studio.show', $studio->id) }}" class="btn btn-ghost btn-sm">Kembali ke Detail</a>
        ...
        <div class="overflow-x-auto">
            <table class="table table-zebra text-sm">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <div class="flex items-center gap-2">
                                @if($paket->gambar)
                                    <img src="{{ asset('storage/' . $paket->gambar) }}" class="w-10 h-10 object-cover rounded">
                                @endif
                        ...
                        <td>
                            <span class="badge {{ $paket->status == 'active' ? 'badge-success' : 'badge-ghost' }}">{{ $paket->status }}</span>
                        </td>
                        <td>
                    ...
                    @empty
                    <tr><td colspan="5" class="text-center text-base-content/60 py-4">Belum ada paket</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
