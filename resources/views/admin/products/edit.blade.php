                                ...
                                <div id="specifications-container">
                                    ...
                                    @else
                                        @foreach($specifications as $key => $value)
                                            <div class="specification-row grid grid-cols-1 md:grid-cols-5 gap-2 mb-2 items-end">
                                                <div class="md:col-span-2">
                                                    <input type="text" class="input-apple w-full" name="spesifikasi[{{ $specIndex }}][key]"
                                                           value="{{ $key }}" placeholder="Nama Spesifikasi">
                                                </div>
                                                <div class="md:col-span-2">
                                                    <input type="text" class="input-apple w-full" name="spesifikasi[{{ $specIndex }}][value]"
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="grid grid-cols-2 gap-2">
                                            @foreach($additionalImages as $index => $image)
                                                <div class="relative">
                                                    <img src="{{ asset('storage/' . $image) }}" alt="Gambar tambahan {{ $product->nama_produk }}"
