            ...
            <div class="card-apple overflow-hidden hover:shadow-md hover:-translate-y-px transition-all duration-300">
                <div class="p-4 sm:p-5">
                    <div class="flex items-start gap-3.5 sm:gap-4">
                        {{-- Gambar --}}
                        <a href="{{ $transaction->detail_link }}" class="shrink-0 w-16 h-16 sm:w-20 sm:h-20 rounded-2xl overflow-hidden bg-[#f5f5f7]" aria-hidden="true" tabindex="-1">
                            @if($itemImage)
                        ...
                        <div class="flex-1 min-w-0">
                            <div class="flex items-start justify-between gap-3">
                                <div class="min-w-0">
                                    ...
                                    <p class="mt-1 flex flex-wrap items-center gap-x-2 gap-y-0.5 text-xs text-[#86868b]">
                                        <span class="font-medium text-[#6e6e73]">{{ $transaction->tipe_label }}</span>
                                        <span aria-hidden="true">&middot;</span>
                                        <span class="font-mono">{{ $transaction->kode }}</span>
                                        <span aria-hidden="true">&middot;</span>
                                        <span>{{ $createdAt }}</span>
                                    </p>
                                </div>
                                <div class="text-right shrink-0">
                                    <p class="text-[15px] sm:text-lg font-bold text-[#1d1d1f] tracking-tight">Rp {{ number_format($transaction->total ?? 0, 0, ',', '.') }}</p>
                                </div>
                            </div>
                            ...
                            <div class="flex flex-wrap items-center gap-2 mt-3.5">
                                <a href="{{ $transaction->detail_link }}" class="btn-dark-apple !text-xs !px-4 !py-2">
                                    Detail
                                </a>
