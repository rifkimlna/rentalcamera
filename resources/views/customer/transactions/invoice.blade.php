...
@section('title', 'Invoice - Stekpro Multimedia & Broadcast')
...
<div class="space-y-4">
    <div class="flex items-center justify-between no-print">
        <a href="{{ route('customer.transactions.show', $transaction->id) }}" class="inline-flex items-center gap-1.5 text-sm font-medium px-4 py-2 rounded-full bg-[#f5f5f7] hover:bg-[#e5e5e7] text-[#1d1d1f] transition-colors">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 py-6 border-b border-[#e5e5e7]">
                <div>
                    ...
                    <p class="text-sm leading-relaxed">
                        ...
                        <span class="text-xs text-[#6e6e73]">{{ $transaction->telepon_customer }}</span><br>
                        <span class="text-xs text-[#6e6e73]">{{ $transaction->email_customer }}</span>
                    </p>
                </div>
                <div>
