...
@section('title', 'Transaksi yang Dapat Diulas - Sewa Kamera Pro')
                            ...
                            <div class="card-body">
                                    ...
                                    <div class="space-y-2">
                                        @foreach($transaction->detailTransaksis as $detail)
                                            <div class="flex items-center gap-2">
                                                ...
                                                @else
                                                    <div class="bg-base-200 rounded flex items-center justify-center w-10 h-10">
                                                        <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 text-base-content/60" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5">
                                ...
                                <div class="flex items-center justify-between">
                                    <div>
                                        ...
                                        <h6 class="mb-0 text-success">Rp {{ number_format($transaction->grand_total, 0, ',', '.') }}</h6>
                                    </div>
