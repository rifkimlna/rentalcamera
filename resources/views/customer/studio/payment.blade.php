                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-sm">
                                    Selesaikan sebelum <strong>{{ \Carbon\Carbon::parse($booking->payment_expired_at)->translatedFormat('d F Y H:i') }}</strong> untuk mengunci jadwal studio Anda.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="rounded-xl bg-[#ff9500]/10 border border-[#ff9500]/20 p-3 flex items-center gap-2 text-sm text-[#ff9500] mt-3">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <p class="mb-0 text-sm">Silakan selesaikan pembayaran sebelum batas waktu untuk mengunci jadwal studio Anda.</p>
                            </div>
                        </div>
                    </div>
                @endif
                {{-- Lock info: sudah lunas tidak bisa bayar lagi --}}
                @if($booking->payment_status === 'paid')
                    <div class="rounded-xl bg-[#34c759]/10 border border-[#34c759]/20 p-3 mt-3 text-sm text-[#1d7a3a]">✅ Sudah dibayar — tidak bisa dibayar lagi. <a href="{{ route('customer.studio.my-bookings') }}" class="underline font-medium">Lihat booking</a></div>
