...
<div class="min-h-[calc(100vh-5rem)] flex flex-col justify-center p-4 sm:p-6">
    <div class="mx-auto w-full max-w-2xl">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        <div class="mb-3">
                            ...
                            <h5 class="font-bold text-[#0071e3]">{{ $booking->layanan->nama_layanan }}</h5>
                        </div>
                        <div class="mb-3">
        ...
        data-success-url="{{ route('customer.layanan.booking.success', $booking->id) }}"
        data-check-url="{{ route('customer.layanan.check-status', $booking->id) }}"
        data-fallback-url="{{ route('customer.layanan.my-bookings') }}">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 me-2 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    ...
                    @else
                        ...
                        <div class="mb-4">
                            <a href="{{ route('customer.layanan.payment', $booking->id) }}" class="btn-dark-apple btn-lg w-full md:w-auto md:px-8">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 me-2 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                ...
                <div class="hidden md:block overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <h6 class="mb-1 font-semibold">{{ $booking->layanan->nama_layanan }}</h6>
                    ...
                    <div class="bg-[#f5f5f7] rounded-lg p-3">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="flex-1 min-w-0">
                                <h6 class="font-semibold text-sm leading-snug">{{ $booking->layanan->nama_layanan }}</h6>
        ...
        <div class="mt-4 flex justify-center">
            <a href="{{ route('customer.layanan.my-bookings') }}"
