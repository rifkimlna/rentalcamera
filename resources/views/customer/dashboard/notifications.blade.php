...
@section('title', 'Notifikasi - Stekpro Multimedia & Broadcast')
...
<div class="space-y-4">
    <div class="flex items-center gap-2">
        ...
        <a href="{{ request()->fullUrlWithQuery(['filter' => 'unread']) }}" class="rounded-xl px-4 py-2 text-sm font-medium transition-all {{ request('filter') === 'unread' ? 'bg-[#1d1d1f] text-white' : 'text-[#6e6e73] hover:bg-[#f5f5f7]' }}">Belum Dibaca</a>
    </div>
            ...
            <div class="flex items-start gap-3">
                ...
                <div class="flex-1 min-w-0">
                    ...
                    <div class="flex items-center gap-2 mt-2">
                        <span class="badge-apple !text-[10px] !px-2 !py-0.5 border border-[#e5e5e7]">{{ $notification->type_label }}</span>
