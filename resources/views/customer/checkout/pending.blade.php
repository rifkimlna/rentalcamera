...
<div class="min-h-[70vh] flex items-center justify-center px-4 py-12">
    <div class="w-full max-w-xl">
        ...
        <div class="card-apple-static">
            <div class="p-5 space-y-3">
                ...
                <div class="flex justify-between items-center py-2 border-b border-[#e5e5e7]">
                    ...
                    <span class="text-sm font-bold text-[#0071e3]">Rp {{ number_format($transaksi->grand_total, 0, ',', '.') }}</span>
                </div>
                <div class="flex justify-between items-center py-2 border-b border-[#e5e5e7]">
        ...
        <div class="text-center mt-6">
            ...
            <a href="{{ route('customer.transactions.show', $transaksi->id) }}" class="btn-outline-apple ml-2">
