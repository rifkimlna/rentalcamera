...
export function NotFound({
  ...
  return (
    <div className="relative text-center z-[1] bg-white text-black">
      ...
      <div className="mt-10 flex flex-col sm:flex-row gap-2 mx-auto sm:max-w-sm">
        <div className="relative w-full">
          <Search className="absolute left-3 top-3 h-4 w-4 text-neutral-400" />
          <Input placeholder="Cari equipment…" className="pl-9" />
        </div>
        <Button variant="outline">Cari</Button>
      </div>
      <div className="mt-10 flex flex-col sm:flex-row sm:items-center sm:justify-center gap-3">
