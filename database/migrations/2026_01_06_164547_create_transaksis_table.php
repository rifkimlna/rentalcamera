...
return new class extends Migration
{
    public function up(): void
    {
        Schema::create('transaksis', function (Blueprint $table) {
            ...
            $table->enum('status_transaksi', ['draft', 'menunggu_pembayaran', 'diproses', 'dikonfirmasi', 'siap_diambil', 'selesai', 'dibatalkan', 'ditolak'])->default('draft');
            ...
            $table->string('metode_pengambilan', 20)->default('pickup');
            $table->string('metode_pengembalian', 20)->default('return');
